...
**Date:** June 20, 2026  
**Scope:** `NoctweaveCore`, Noctyra client (iOS/macOS), Noctyra Relay (macOS), Linux/Docker relay, tests, and operator documentation.
...
- `NoctweaveCore`: 62 unit/integration tests pass, including encrypted federation
...
Protocol/store changes are concentrated in `NoctweaveCore/Sources/NoctweaveCore/`,
with matching Linux definitions and handlers in
`Noctweave Relay Server/Sources/NoctweaveRelayServer/`. Client migration and
