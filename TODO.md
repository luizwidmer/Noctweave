...
- [x] Align OS-permitted wake tuning into a bounded execution gate: core now converts relay-advertised wake cycle plans into capped prefetch execution plans with explicit profile-count, per-profile envelope, long-poll envelope, and total-cycle envelope limits.
