...
public enum InboxAddress {
    ...
    public static func derived(from accessPublicKey: Data) -> String {
        Bech32.encode(hrp: hrp, data: Array(SHA256.hash(data: accessPublicKey)))
    }

    public static func isBound(_ address: String, to accessPublicKey: Data) -> Bool {
        address.lowercased() == derived(from: accessPublicKey)
    }

    public static func decode(_ address: String) -> Data? {
