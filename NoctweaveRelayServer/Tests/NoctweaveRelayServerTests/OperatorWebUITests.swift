...
final class OperatorWebUITests: XCTestCase {
    func testOperatorUIUsesExternalAssetsAndStrictControlPlaneLanguage() {
        ...
        XCTAssertTrue(OperatorWebUI.javascript.contains("setVisible(\".federationOnly\",federation)"))
        XCTAssertTrue(OperatorWebUI.javascript.contains("setVisible(\".soloOnly\",!federation)"))
        XCTAssertTrue(OperatorWebUI.javascript.contains("setVisible(\".openOnly\",open)"))
        XCTAssertTrue(OperatorWebUI.javascript.contains("setVisible(\".openPeerConditional\",open)"))
        XCTAssertTrue(OperatorWebUI.javascript.contains("setConditional(\".onionConditional\",onion)"))
        XCTAssertTrue(OperatorWebUI.javascript.contains("setConditional(\".mixnetConditional\",mixnet)"))
        XCTAssertTrue(OperatorWebUI.javascript.contains(#"advanced:["Experimental","Privacy research"]"#))
        XCTAssertTrue(OperatorWebUI.html.contains("Full Runtime Details"))
        XCTAssertTrue(OperatorWebUI.html.contains("TLS / proxy trust"))
        XCTAssertTrue(OperatorWebUI.javascript.contains("container.hidden=!enabled"))
        XCTAssertTrue(OperatorWebUI.html.contains("Independent relay"))
