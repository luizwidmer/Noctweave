...
1. Distribute group ratchet epoch secrets through signed group commits and join approvals.
2. Teach clients to fetch/decrypt relay group-inbox ciphertexts with the group ratchet.
