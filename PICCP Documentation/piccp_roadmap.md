...
- [ ] Add coverage reporting for `PICCPCore` and the Linux relay package.
...
- [ ] Decide whether `PICCPCore` should publish a stable public library API or remain an internal protocol package.
