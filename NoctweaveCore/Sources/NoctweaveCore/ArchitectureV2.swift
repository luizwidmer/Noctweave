...
public struct ProtocolCapabilityManifest: Codable, Equatable {
    ...
    public static let knownModuleCatalog: [ProtocolModuleCapability] = [
        ...
        ProtocolModuleCapability(module: "nw.call", versions: [1], status: .experimental),
        ...
        ProtocolModuleCapability(module: "nw.federation-forward", versions: [1], status: .provisional),
        ...
        ProtocolModuleCapability(module: "nw.noctweb-data", versions: [1], status: .experimental),
