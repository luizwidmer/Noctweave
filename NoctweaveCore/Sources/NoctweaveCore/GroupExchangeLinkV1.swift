...
public enum NoctweaveGroupExchangeLinkError: Error, LocalizedError {
    case invalidLink
    case expiredLink
...
/// through an authenticated and encrypted channel. The local `admissionID`
/// creates no persona, account, or device link.
public struct NoctweaveGroupAdmissionRequestLinkV1: Codable {
    public static let prefix = "noctweave-group-admission-v1:"
...
/// Existing-member output for exactly one saved group admission request.
/// The request digest prevents a valid welcome from being applied to a
/// different pending admission.
public struct NoctweaveGroupAdmissionResponseLinkV1: Codable {
    public static let prefix = "noctweave-group-welcome-v1:"
    public static let version = 1
    ...
    public func matches(_ request: NoctweaveGroupAdmissionRequestLinkV1) -> Bool {
